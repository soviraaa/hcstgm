...
const members = ['insanepeople59'];
const userIds = ['49091655652'];
...
const Twitter = new twit({
  consumer_key: process.env.zMYZWbnz8WP8ZLdUrJcP6oj8w,
  consumer_secret: process.env.sjczacD2ev3EUXUmXiUeuWnwhQ2SMS7sfU38Vz2o9taj92WF0B,
  access_token: process.env.1057321332193382400-ulijTsfr6wX0bqc80dn2Zjf6Hdy8Rz,
  access_token_secret: process.env.NROq6xmaiqUsx3OCBOdOclTOdvp99iro4Mj0PXKeqlqAu,
  timeout_ms: 60*1000,
});
